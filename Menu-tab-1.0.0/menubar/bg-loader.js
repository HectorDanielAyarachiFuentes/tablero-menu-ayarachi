...
(() => {
  ...
  // Definimos los temas aquí también para que estén disponibles de inmediato.
  // Esto es una pequeña duplicación, pero es necesaria para evitar FOUC.
  // Una alternativa sería cargarlos desde un JSON, pero esto es más rápido.
  const THEMES = {
    'paisaje': {
