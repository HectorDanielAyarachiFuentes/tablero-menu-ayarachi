...
export const DOODLES = [
  ...
  },
  {
    ...
    // ✨ CORRECCIÓN CLAVE: Las reglas se envuelven en una etiqueta <style>.
    // Esto evita que el navegador intente analizar el SVG antes de tiempo.
    template: `<css-doodle click-to-update>
      <style>
        :doodle {
          @grid: 1 / 100vw 100vh;
...
export function initDoodleSettings(activeDoodleId) {
  ...
  DOODLES.forEach(doodle => {
    ...
    // ✨ CORRECCIÓN DE SINTAXIS: Se usan backticks (`) para crear una cadena de texto
    // de varias líneas y se añade '' como valor por defecto.
    button.innerHTML = `
