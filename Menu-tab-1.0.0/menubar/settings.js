...
export function applyTheme(themeId) {
    ...
    document.body.style.setProperty('--bg-image', theme.background);
...
export function applyGradient(gradientId) {
    ...
    document.body.style.setProperty('--bg-image', gradient.gradient);
}
...
function applyBackgroundSettings(settings) {
    ...
    if (isCustomBg) {
        ...
        document.body.style.setProperty('--bg-image', appState.currentBackgroundValue);
    }
